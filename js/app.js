(function () {
  ...
  function updatePosition(event) {
    ...
    if (window.SafeBoatSithonia && window.SafeBoatSithonia.updatePosition) try { window.SafeBoatSithonia.updatePosition(event); } catch (_) { showMessage('Sitonija vodič trenutno nije dostupan.'); }
